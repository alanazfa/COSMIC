...
% Falah updating branch data for the two islands
branches1      = ismember(ps.branch(:,24),ps1.branch(:,24)); 
branches2      = ismember(ps.branch(:,24),ps2.branch(:,24));
ps.branch(branches1,C.br.status:C.br.Qt)  = ps1.branch(:,C.br.status:C.br.Qt);
ps.branch(branches2,C.br.status:C.br.Qt)  = ps2.branch(:,C.br.status:C.br.Qt);
triped_lines   = (ps.branch(:,C.br.status)==0);
ps.branch(triped_lines,C.br.status:C.br.Qt) = 0;
